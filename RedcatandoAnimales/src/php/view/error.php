...
<head>
    ...
    <title>ERROR | Redcatando Animales</title>
...
<body class="bg-light">
    <main class="container container-fluid">
        <div class="error-box text-center">
            <img src="/RedcatandoAnimales/RedcatandoAnimales/res/imgs/sad_dog.png" width=420 height=420 alt="">
            <h2 class="error-title">¡Ha ocurrido un error!</h2>
            <p>¡Lo sentimos mucho! 😞, por lo pronto presiona <strong>VOLVER</strong></p>
            <a href="index.php" class="btn btn-link btn-lg">VOLVER</a>
        </div>
    </main>
</body>
